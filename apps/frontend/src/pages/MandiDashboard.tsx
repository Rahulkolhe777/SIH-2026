...
import { Sprout, LogOut, Store } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#07140d] text-white">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12 lg:px-10">
        <div className="mb-8">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-yellow-400/10 px-4 py-1.5 text-xs text-yellow-300">
          ...
          <p className="mt-2 text-white/60">
            Manage your mandi operations, review slot requests, and coordinate
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            { label: "Pending Requests", value: "0", color: "text-yellow-400" },
            { label: "Active Slots", value: "0", color: "text-green-400" },
            { label: "Today's Arrivals", value: "0", color: "text-blue-400" },
          ].map((stat) => (
            <div
              key={stat.label}
